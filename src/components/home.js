      ...
      <div className="Home">
        <div className="card Homecard border-0  mx-lg-5 d-flex">
          <div className="row  g-0">
              ...
              <div className="card-body">
                ...
                <div className="card-text mt-5 ">
                  <a href="https://interviewready.io/learn/system-design-course/how-do-i-use-this-course/what-do-we-offer">
                    <button
                      type="button"
                      className="btn p-2 rounded-5 Trybtn btn-md "
                    >
                      Try for Free
                    </button>
                  </a>
            ...
            <div className="videobio text-lg-start d-flex ">
            ...
            <div className="company-stats">
              <div className="company-logos row  row-cols-2 row-cols-sm-3   row-cols-md-4 row-cols-lg-6  ">
                <div>
                  <svg
