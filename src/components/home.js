          ...
          <div className="row  g-0">
            <div className="col-md-6 ">
              <div className="card-body">
                ...
                <div className="card-text mt-3  mt-lg-5 ">
                  <a href="https://interviewready.io/learn/system-design-course/how-do-i-use-this-course/what-do-we-offer">
                    <button
                      type="button"
                      className="btn p-2 w-50 rounded-5 Trybtn btn-md "
                    >
                      Try for Free
                    </button>
                  </a>
                  <p className="mt-2 mt-lg-4 ">
                    One time Purhase. Lifetime Access
                  </p>
                </div>
              </div>
              <div className="videobio  w-100    d-none d-md-block  text-lg-start d-flex ">
                <p className="fw-bold fs-5 ">
                  Tursted byTursted by
                  <b className="text-primary mx-1"> 16000 </b> Engineers who  got
                  their dream job at
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6  ">
              <video
                className="img-fluid mt-md-5 mt-lg-5 pt-lg-5  mt-xl-2  pt-xl-0   rounded-3"
                poster="img/thumbnailFvideo.png"
                controls
                src="img/Intro.mp4"
              ></video>
            </div>
            <div className="videobio text-center  w-100  d-block  d-md-none    d-flex ">
              <p className="fw-bold fs-5 ">
                Tursted byTursted by
                <b className="text-primary mx-1"> 16000 </b> Engineers who got
                their dream job at
            ...
            <div className="company-stats">
              <div className="company-logos text-center   row  row-cols-2 row-cols-sm-4  row-cols-md-6 ">
                <div className="mt-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 603.9 129"
                    width={100}
                    className="lgcomicon1"
                  >
                    <path
                      fill="#737373"
